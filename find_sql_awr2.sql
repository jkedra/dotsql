...
WHERE UPPER(DBMS_LOB.SUBSTR(sql_text,4000)) LIKE UPPER('%&sql_text%')
AND DBMS_LOB.SUBSTR(sql_text,4000) NOT LIKE '%DBMS_LOB.SUBSTR(sql_text,4000) NOT LIKE %'
/
